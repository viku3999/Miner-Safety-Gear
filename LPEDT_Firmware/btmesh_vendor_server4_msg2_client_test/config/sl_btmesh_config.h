...
#define SL_BTMESH_CONFIG_MAX_PROVISIONED_DEVICE_APPKEYS       2
...
#define SL_BTMESH_CONFIG_MAX_PROVISIONED_DEVICE_NETKEYS       2
...
#define SL_BTMESH_CONFIG_MAX_FOUNDATION_CLIENT_CMDS       2
...
#define SL_BTMESH_CONFIG_MAX_FRIENDSHIPS       4
