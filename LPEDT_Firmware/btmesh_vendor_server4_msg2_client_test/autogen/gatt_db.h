...
#define gattdb_temperature_measurement        45
#define gattdb_temperature_type               48
#define gattdb_intermediate_temperature       50
#define gattdb_measurement_interval           53
#define gattdb_valid_range                    55
