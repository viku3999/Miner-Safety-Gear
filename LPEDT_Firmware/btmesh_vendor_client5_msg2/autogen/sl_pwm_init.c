...
sl_pwm_instance_t sl_pwm_buzzer_msg = {
  ...
  .channel = (uint8_t)(SL_PWM_BUZZER_MSG_OUTPUT_CHANNEL),
  .port = (uint8_t)(SL_PWM_BUZZER_MSG_OUTPUT_PORT),
  .pin = (uint8_t)(SL_PWM_BUZZER_MSG_OUTPUT_PIN),
#if defined(SL_PWM_BUZZER_MSG_OUTPUT_LOC)
  .location = (uint8_t)(SL_PWM_BUZZER_MSG_OUTPUT_LOC),
#endif
};
